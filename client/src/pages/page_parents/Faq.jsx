        ...
        <Accordion variant="splitted">
          ...
          >
            <p className="texts">
              ...
              agence web basée à <strong>Nantes</strong>. L'intégralité du
              contenu présent sur le site, ainsi que la promotion du site, est
              effectuée par <strong>DaveWarehouse</strong>. Pour plus de
              détails, consultez la page de mentions légales.
            </p>
          </AccordionItem>
          <AccordionItem
            className="texts"
          ...
          >
            <p className="texts">
              ...
              nombreux services, aux particuliers comme aux professionnels, liés
              à l'accueil de la petite enfance en France.
            </p>
          </AccordionItem>
          <AccordionItem
            className="texts"
          ...
          >
            <p className="texts">
              Nous vous invitons à nous signaler le problème via le formulaire
              de contact, en nous indiquant l'adresse de la page d'erreur,
              située en haut de votre navigateur et qui commence par
              «babyplace.fr». Veuillez aussi nous indiquer la page où se
              trouvait le lien qui vous a mené à la page d'erreur. Ces
              signalements nous permettront d'améliorer Babyplace.
            </p>
          </AccordionItem>
          <AccordionItem
            className="texts"
          ...
          >
            <p className="texts">
              ...
              Twitter, en indiquant notre compte (@babyplace) dans votre
              message.
            </p>
          </AccordionItem>
          <AccordionItem

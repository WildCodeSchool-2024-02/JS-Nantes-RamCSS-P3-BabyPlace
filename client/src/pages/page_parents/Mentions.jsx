  ...
  return (
    <section className="mentions">
      ...
      <p className="texts">
        ...
        reproduction sans le consentement explicite de l’auteur est strictement
        interdite.
      </p>
      <h2 className="texts adaptatif-text">Responsabilité</h2>
      <p className="texts">
        Les documents, liens et informations contenus sur le site sont présentés
        à titre purement informatif et ne sauraient en aucun cas engager notre
        responsabilité.
      </p>
      ...
      <p className="texts">
        ...
        données sont uniquement les responsables du site. Aucune donnée ne sera
        transmise à un tiers. Des cookies (fichiers texte contenant des
        ...
        de les bloquer automatiquement à l’aide des fonctions de son navigateur.
        En utilisant notre site Internet, vous consentez à la collecte et à
        l’utilisation de ces données. Conformément à l’article 34 de la loi «
